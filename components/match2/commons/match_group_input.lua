...
function MatchGroupInput.readContext(args)
	local context = {
		...
		matchSection = args.matchsection or globalVars:get('matchsection'),
		sectionHeader = args.section or globalVars:get('bracket_header'),
...
function MatchGroupInput.readGroupRoundIndex(args)
	...
	local matchSection = args.matchsection or globalVars:get('matchsection')
