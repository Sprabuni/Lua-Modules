...
function StarcraftOpponentDisplay.InlineOpponent(props)
	...
	elseif Opponent.typeIsParty(opponent.type) then
		return StarcraftOpponentDisplay.InlineParty(props)
	else
...
function StarcraftOpponentDisplay.BlockOpponent(props)
	...
	elseif Opponent.typeIsParty(opponent.type) then
		return StarcraftOpponentDisplay.BlockParty(props)
...
StarcraftOpponentDisplay.propTypes.InlineParty = {
	flip = 'boolean?',
	opponent = StarcraftOpponent.types.Opponent,
	overflow = TypeUtil.optional(DisplayUtil.types.OverflowModes),
	showFlag = 'boolean?',
...
function StarcraftOpponentDisplay.InlineParty(props)
...
StarcraftOpponentDisplay.propTypes.BlockParty = {
	flip = 'boolean?',
	opponent = StarcraftOpponent.types.Opponent,
	overflow = TypeUtil.optional(DisplayUtil.types.OverflowModes),
	showFlag = 'boolean?',
...
function StarcraftOpponentDisplay.BlockParty(props)
	local opponent = props.opponent
	local showRace = props.showRace ~= false
